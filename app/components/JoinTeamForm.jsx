...
// Mock Navbar component - replace with your actual Navbar import
const Navbar = () => (
  <nav className="bg-white shadow-lg">
    <div className="max-w-7xl mx-auto px-4">
      <div className="flex justify-between items-center py-4">
        <div className="flex items-center">
          <span className="text-2xl font-bold text-orange-500">Perception Cleaner</span>
        </div>
        <div className="hidden md:flex space-x-8">
          ...
          <a href="#careers" className="text-gray-700 hover:text-orange-500 transition-colors">Careers</a>
