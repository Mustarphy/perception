      ...
      <div className="max-w-full mx-auto">
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-4 lg:grid-cols-3 gap-18">
              <div
                className="rounded-2xl p-6 relative overflow-hidden flex flex-col group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 bg-cover bg-center bg-no-repeat
                 bg-[#8B5CF6]"
              >
        ...
        <span>💰</span>
                ...
                <p className="text-gray-600 text-sm">
                  Referal Gift of $50 once your referred client Signed up !
                </p>
                </div>
              </div>
              <div
        ...
        <span>💰</span>
                ...
                <div className="bg-white rounded-xl p-4 mt-2 shadow-lg">
                <p className="text-gray-600 text-sm">
                  Referral Gift of $50 once your referred client Signed up !. <br/> We will reduce your preexit bill by 25% of you Sign up for 6 months.
                </p>
