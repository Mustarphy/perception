    ...
    <section className="bg-[#f9f9ff] py-16 px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-3xl">
                ...
                description="We understand the importance of punctuality, and our team will arrive on time to ensure there is no dekay"
                />
                <FeatureCard 
                imageSrc="Icon3.png"
        ...
        <div className="mt-12 items-start">
            ...
            <div className=" animate-marquee flex flex-wrap justify-evenly gap-4">
